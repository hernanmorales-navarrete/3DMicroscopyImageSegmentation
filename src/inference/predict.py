...
class Prediction:
    ...
    def __init__(
        ...
        self.models_list = get_deep_learning_models_from_dir(
    ...
    def predict(self):
        for subdir in self.subdirs_corresponding_to_image_names:
            ...
            image_patches_absolute_paths = sorted(
                subdir.glob("*"),
            ...
            logger.info(
                "Applying deep learning methods for patches, saving them, reconstructing the patches and saving the entire image"
            )
