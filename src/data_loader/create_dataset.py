...
def create_tf_datasets(dir, patch_shape, patch_step, percent_val=0, random_state=42):
    ...
    if percent_val != 0:
        train_patches, val_patches, train_masks, val_masks = train_test_split(
            patches, masks, test_size=percent_val, random_state=random_state
        )
        ...
        raise ValueError("Validation percentage must be greater than 0")
